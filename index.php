	...
	<div class="jumbotron jumbotron-fluid mb-3 pt-0 pb-0 bg-lightblue position-relative">
		<div class="pl-4 pr-0 h-100 tofront">
			<div class="row justify-content-between">
				...
				<div class="col-md-6 d-none d-md-block pr-0" style="background-size:cover;background-image:url(<?php echo get_theme_file_uri() ?>/assets/img/demo/home.jpg);">	</div>
			</div>
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="card border-0 mb-4 box-shadow h-xl-300">              
                <div style="background-image: url(<?php echo get_theme_file_uri() ?>/assets/img/demo/1.jpg); height: 150px;    background-size: cover;    background-repeat: no-repeat;"></div>               
			...
			<div class="flex-md-row mb-4 box-shadow h-xl-300">
				<div class="mb-3 d-flex align-items-center">
					...
					<div class="pl-3">
						...
						<a class="text-dark" href="<?php echo get_theme_file_uri() ?>/article.html">Nasa's IceSat space laser makes height maps of Earth</a>
						</h2>
				...
				<div class="mb-3 d-flex align-items-center">
					<img height="80" src="<?php echo get_theme_file_uri() ?>/assets/img/demo/blog5.jpg">
					<div class="pl-3">
						<h2 class="mb-2 h6 font-weight-bold">
				...
				<div class="mb-3 d-flex align-items-center">
					<img height="80" src="<?php echo get_theme_file_uri() ?>/assets/img/demo/blog6.jpg">
					<div class="pl-3">
						<h2 class="mb-2 h6 font-weight-bold">
	...
	<div class="row justify-content-between">
		<div class="col-md-8">
			...
			<div class="mb-3 d-flex justify-content-between">
				...
				<img height="120" src="<?php echo get_theme_file_uri() ?>/assets/img/demo/1.jpg">
			</div>
			<div class="mb-3 d-flex justify-content-between">
				<div class="pr-3">
					<h2 class="mb-1 h4 font-weight-bold">
				...
				<img height="120" src="<?php echo get_theme_file_uri() ?>/assets/img/demo/5.jpg">
			</div>
		</div>
